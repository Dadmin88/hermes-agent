...
const OPTIONS: ModeOption[] = [
  ...
  },
  {
    ...
    mode: 'data',
    title: 'Delete all my data from Hermes',
    description: 'Delete config, chats, secrets, and logs.',
    consequence: 'all of your Hermes data — config, chats, secrets, scheduled jobs, and logs',
    needsAgent: false
  }
]
      ...
      <div className="rounded-xl border border-destructive/30 bg-destructive/5 px-4 py-3">
        {loading ? (
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-xs text-muted-foreground">
              {nativeRemoval
                ? 'Before uninstalling, you can chose to delete all your Hermes data.'
