...
//   node scripts/gen-msix-manifest.mjs [light|bundled] [x64|arm64]
//
...
if (!["bundled", "light"].includes(variant)) {
  console.error(`variant must be 'bundled' or 'light', got '${variant}'`)
  process.exit(1)
}
...
const executable = `app\\${config.productName}.exe`
