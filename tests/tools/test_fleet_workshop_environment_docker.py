...
def test_hermes_enters_exact_fleet_workshop_without_lifecycle_authority() -> None:
    ...
    create = subprocess.run(
        [
            ...
            "/workspace",
            "--tmpfs",
            "/workspace:rw,nosuid,nodev,exec,size=33554432,uid=65532,gid=65532,mode=0711",
            "--tmpfs",
            "/workspace/inputs:rw,nosuid,nodev,exec,size=16777216,uid=65533,gid=65533,mode=0755",
            "--tmpfs",
